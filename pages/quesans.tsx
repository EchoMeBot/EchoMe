...
return (
  <Layout title="EchoMe" hasTabBar>
    <div className="h-screen transition-colors dark:text-gray-200 dark:bg-slate-900">
      <div className="w-full max-w-md mx-auto pt-20 pb-20">
      ...
      <div className="fixed inset-0 flex items-center justify-center">
        <div className="absolute bg-gray-100 shadow-lg rounded p-6 w-96 h-60">
          ...
          <div className="flex justify-center mt-4">
            <button
              onClick={closeModal}
              className="w-full bg-gray-400 text-white p-2 rounded mr-2"
            >
              취소
            </button>
            <button
